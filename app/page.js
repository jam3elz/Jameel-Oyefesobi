...
const projects = [
  {
    ...
    tags: ["Python", "MySQL", "Data Analysis", "Visualization"],
            ...
            <div className="text-center md:text-left">
              ...
              <div className="mt-6 flex gap-4 justify-center md:justify-start">
                <a 
                  href="/Jameel-CV.pdf" 
                  download
                  className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition shadow-lg inline-flex items-center gap-2"
                >
                ...
                <button onClick={() => scrollTo("projects")} className="px-6 py-3 bg-white text-blue-600 border-2 border-blue-600 rounded-lg hover:bg-blue-50 transition">
                  View My Work
                </button>
